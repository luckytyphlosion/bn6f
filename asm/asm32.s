...
loc_8118162:
	...
	sub r1, #0x90
	lsr r1, r1, #2
	ldr r0, off_8118194 // =TextScript873EA50
	ldrb r4, [r5,#4]
	lsl r4, r4, #2
...
off_8118194: .word TextScript873EA50
...
loc_8118CA6:
	...
	strb r1, [r5,#0xc]
	push {r4-r7}
	ldr r0, off_8118CDC // =TextScript873EA50
...
loc_8118CD4:
	...
	pop {r4-r7,pc}
	.balign 4, 0
off_8118CDC: .word TextScript873EA50
...
loc_81199F8:
	...
	pop {r5,r6}
	push {r5,r6}
	ldr r0, off_8119A34 // =TextScript873EA50
	ldrh r1, [r6,#0x1c]
...
off_8119A34: .word TextScript873EA50
...
loc_811B74A:
	...
	sub r1, #0x90
	lsr r1, r1, #2
	ldr r0, off_811B77C // =TextScript873EA50
	ldrb r4, [r5,#4]
	lsl r4, r4, #2
...
off_811B77C: .word TextScript873EA50
...
sub_811E024:
	push {lr}
	ldr r6, off_811E044 // =eStruct2001010
...
off_811E038: .word sub_811E048+1
	.word sub_811E090+1
	.word sub_811E0B2+1
off_811E044: .word eStruct2001010
...
off_811E164: .word eStruct2001010
	thumb_func_end sub_811E0BA

	thumb_func_start sub_811E168
sub_811E168:
	push {lr}
	ldr r6, off_811E188 // =eStruct2001010
...
off_811E17C: .word sub_811E18C+1
	.word sub_811E1D4+1
	.word sub_811E1FA+1
off_811E188: .word eStruct2001010
...
sub_811E6C0:
	push {lr}
	ldr r6, off_811E6E0 // =eStruct2001010
...
off_811E6D4: .word sub_811E6E4+1
	.word sub_811E72C+1
	.word sub_811E73C+1
off_811E6E0: .word eStruct2001010
...
sub_811E7D4:
	push {lr}
	ldr r6, off_811E7F4 // =eStruct2001010
...
off_811E7E8: .word sub_811E7F8+1
	.word sub_811E840+1
	.word sub_811E850+1
off_811E7F4: .word eStruct2001010
...
sub_811E858:
	push {lr}
	ldr r6, off_811E878 // =eStruct2001010
...
off_811E86C: .word sub_811E87C+1
	.word sub_811E8C4+1
	.word sub_811E8D8+1
off_811E878: .word eStruct2001010
...
sub_811E914:
	push {lr}
	ldr r6, off_811E934 // =eStruct2001010
...
off_811E928: .word sub_811E938+1
	.word sub_811E980+1
	.word sub_811E998+1
off_811E934: .word eStruct2001010
...
sub_811E9A0:
	push {lr}
	ldr r6, off_811E9C0 // =eStruct2001010
...
off_811E9B4: .word sub_811E9C4+1
	.word sub_811EA0C+1
	.word sub_811EA20+1
off_811E9C0: .word eStruct2001010
...
loc_811ED8E:
	bl sub_811F0C8
	bl sub_811F11C
	bl CopyBackgroundTiles_PET_811EF70 // () -> void
	mov r1, #0x10
	ldrsh r0, [r5,r1]
	cmp r0, #0
	blt locret_811EDA6
...
off_811EF88: .word PET_Gfx_tileIds
	thumb_func_end CopyBackgroundTiles_PET_811EF70
...
off_811F0C0: .word TextScript86CB360
...
off_811F5B8: .word TileIds_86CB21C
	...
	thumb_func_end CopyBackgroundTiles_onNaviSelect_811F54C
...
sub_8120280:
	...
	mov r6, #0
	mov r1, r4
	ldr r0, off_81202AC // =TextScript873EA50
	lsl r1, r1, #1
	ldrh r1, [r0,r1]
	add r0, r0, r1
	ldr r4, [sp]
	...
	pop {r4-r7,pc}
	.balign 4, 0
off_81202AC: .word TextScript873EA50
